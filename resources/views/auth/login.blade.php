...
@section('title', 'Login - Perpustakaan Sekolah')
    ...
    <div class="card" style="width: 480px; margin: 40px auto; box-shadow: 0 15px 35px rgba(30,60,114,0.15); border-radius: 20px; overflow: hidden; position: relative;">
        ...
        <div style="padding: 30px;">
            <div style="text-align: center; margin-bottom: 25px;">
                ...
                <h2 style="color: #1e3c72; font-weight: 700; margin-bottom: 5px; font-size: 24px;">Selamat Datang Kembali</h2>
                <p style="color: #64b5f6; font-size: 14px; margin: 0; font-weight: 500;">Akses sistem perpustakaan digital</p>
            </div>

            @if(session('success'))
                <div class="alert alert-success" style="border-radius: 12px; border: none; background: linear-gradient(135deg, #e8f5e8, #c8e6c9); color: #2e7d32; box-shadow: 0 4px 12px rgba(46,125,50,0.15);">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <div style="position: relative;">
                        ...
                        <span style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); font-size: 20px; color: #64b5f6;">✉️</span>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div style="position: relative;">
                        ...
                        <span style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); font-size: 20px; color: #64b5f6;">🔑</span>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 25px;">
                    <button type="submit" class="btn" 
                        ...
                        <span style="display: flex; align-items: center; justify-content: center; gap: 12px; position: relative; z-index: 2;">
                            <span style="font-size: 20px;">🚀</span>
                            <span>Masuk ke Perpustakaan Digital</span>
                        </span>
                    </button>
                </div>
            </form>
            ...
            <!-- Divider -->
            <div style="display: flex; align-items: center; margin: 25px 0; opacity: 0.6;">
                <div style="flex: 1; height: 1px; background: linear-gradient(90deg, transparent, #64b5f6, transparent);"></div>
                <span style="padding: 0 20px; color: #64b5f6; font-weight: 500;">atau</span>
                <div style="flex: 1; height: 1px; background: linear-gradient(90deg, transparent, #64b5f6, transparent);"></div>
            </div>

            <!-- Register Link -->
            <div style="text-align: center;">
                <p style="color: #64b5f6; font-size: 16px; margin-bottom: 15px; font-weight: 500;">Belum memiliki akun?</p>
...
<style>
/* Advanced Styling for Library Theme */
...
.header div[style*="position: absolute"]:nth-child(2) {
    animation-delay: -2s;
}

.header div[style*="position: absolute"]:nth-child(3) {
    animation-delay: -4s;
}

.header div[style*="position: absolute"]:nth-child(4) {
    animation-delay: -1s;
}
...
.container {
    background: 
        radial-gradient(circle at 20% 20%, rgba(30,60,114,0.03) 0%, transparent 50%),
        radial-gradient(circle at 80% 80%, rgba(100,181,246,0.03) 0%, transparent 50%),
        radial-gradient(circle at 40% 40%, rgba(42,82,152,0.02) 0%, transparent 50%);
}
...
@media (max-width: 768px) {
    ...
    .header div[style*="font-size: 48px"] {
